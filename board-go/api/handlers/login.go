...
type GinJWTMiddleware struct {
	...
	LoginResponse func(c *gin.Context, code int, message string, time time.Time, userId string)
...
func (mw *GinJWTMiddleware) MiddlewareInit() error {
	...
	if mw.LoginResponse == nil {
		mw.LoginResponse = func(c *gin.Context, code int, token string, expire time.Time, userId string) {
...
func (mw *GinJWTMiddleware) LoginHandler(c *gin.Context) {
	...
	phone := data.(*UserParam).Phone
	mw.LoginResponse(c, http.StatusOK, tokenString, expire, repository.FindUserId(phone))
}
